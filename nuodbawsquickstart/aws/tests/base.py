...
import nuodbawsquickstart.exception
import os
import random
import tempfile
import time
...
if not os.path.exists(config_file):
  raise nuodbawsquickstart.Error("Can't find required config file %s" % config_file)
...
class Base(unittest.TestCase):
  ...
  def setUpClass(cls):
    ...
    cls._zone = nuodbawsquickstart.aws.Zone(name=aws_region, vpc_id=aws_vpc_id)
    ...
    cls._host = nuodbawsquickstart.aws.Host(
                        name = name,
